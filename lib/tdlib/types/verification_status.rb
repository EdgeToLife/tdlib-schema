module TD::Types
  ...
  # @attr bot_verification_icon_custom_emoji_id [Integer] Identifier of the custom emoji to be shown as verification sign provided by a bot for the user; 0 if none.
